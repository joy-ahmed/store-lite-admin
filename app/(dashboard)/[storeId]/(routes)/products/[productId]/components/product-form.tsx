...
const ProductForm = ({ initialData, categories, sizes, colors }: ProductFormProps) => {
  ...
  const description = initialData ? 'Edit your product here' : 'Create your product here';
  const toastMessage = initialData ? 'Product updated successfully 👏👏' : 'Product created 🎉';
  ...
  const onDelete = async () => {
    try{
      ...
      toast.error("Make sure you removed/backup your data 🙌")
    }finally{
      setLoading(false);
      setOpen(false);
    }
