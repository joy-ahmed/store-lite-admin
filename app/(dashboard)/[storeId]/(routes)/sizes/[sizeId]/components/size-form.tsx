...
const SizeForm = ({ initialData }: SizeFormProps) => {
  ...
  const description = initialData ? 'Edit your Size here' : 'Create your Size here';
  const toastMessage = initialData ? 'Size updated successfully 👏👏' : 'Size created 🎉';
